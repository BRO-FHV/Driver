...
void GPIO1ModuleClkConfig(void)
{
    ...
    while(CM_PER_L3_CLKCTRL_MODULEMODE_ENABLE !=
          (reg32a(SOC_CM_PER_REGS, CM_PER_L3_CLKCTRL,CM_PER_L3_CLKCTRL_MODULEMODE)));
    ...
    while(CM_PER_L3_INSTR_CLKCTRL_MODULEMODE_ENABLE !=
          (reg32a(SOC_CM_PER_REGS, CM_PER_L3_INSTR_CLKCTRL,
    ...
    while(CM_PER_L3_CLKSTCTRL_CLKTRCTRL_SW_WKUP !=
          (reg32a(SOC_CM_PER_REGS , CM_PER_L3_CLKSTCTRL,
    ...
    while(CM_PER_L3S_CLKSTCTRL_CLKTRCTRL_SW_WKUP !=
          (reg32a(SOC_CM_PER_REGS , CM_PER_L3S_CLKSTCTRL,
    ...
    while(CM_PER_OCPWP_CLKCTRL_MODULEMODE_ENABLE !=
          (reg32a(SOC_CM_PER_REGS , CM_PER_OCPWP_CLKCTRL,
    ...
    while(CM_PER_OCPWP_L3_CLKSTCTRL_CLKTRCTRL_SW_WKUP !=
          (reg32a(SOC_CM_PER_REGS , CM_PER_OCPWP_L3_CLKSTCTRL,
    ...
    while((CM_PER_L3_CLKCTRL_IDLEST_FUNC << CM_PER_L3_CLKCTRL_IDLEST_SHIFT)!=
          (reg32a(SOC_CM_PER_REGS , CM_PER_L3_CLKCTRL,
    ...
    */
    ...
    while(CM_PER_L4LS_CLKCTRL_MODULEMODE_ENABLE !=
          (reg32a(SOC_CM_PER_REGS , CM_PER_L4LS_CLKCTRL,
    ...
    while(CM_PER_L4LS_CLKSTCTRL_CLKTRCTRL_SW_WKUP !=
          (reg32a(SOC_CM_PER_REGS , CM_PER_L4LS_CLKSTCTRL,
    ...
    */
    ...
    while(CM_PER_GPIO1_CLKCTRL_MODULEMODE_ENABLE !=
          (reg32a(SOC_CM_PER_REGS , CM_PER_GPIO1_CLKCTRL,
